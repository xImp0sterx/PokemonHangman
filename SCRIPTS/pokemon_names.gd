...
var pokemon_names = {
	...
	"gen4": [
		...
		"Finneon", "Lumineon", "Mantyke", "Snover", "Abomasnow", "Weavile", "Magnezone", 
	...
	"gen7": [
		...
		"Brionne", "Primarina", "Pikipek", "Trumbeak", "Toucannon", "Yungoos", 
		"Gumshoos", "Grubbin", "Charjabug", "Vikavolt", "Crabrawler", "Crabominable", 
	...
	"gen8": [
		...
		"Alcremie", "Falinks", "Pincurchin", "Snom", "Frosmoth", "Stonjourner", 
		"Eiscue", "Indeedee", "Morpeko", "Cufant", "Copperajah", "Dracozolt", "Arctozolt", 
